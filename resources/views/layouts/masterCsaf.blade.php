...
.sidebar-custom-color {
    background-color: rgb(82, 62, 229); /* Vous pouvez ajuster cette couleur selon vos préférences */
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="public/dist/img/logo.png" alt="logo" height="60" width="60">
        </div>
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a class="nav-link" href="{{route('CSAF/acceuil')}}">Acceuil</a>
                </li>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{route('CSAF/acceuil')}}" class="nav-link active">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('CSAF/affectes')}}">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('CSAF/demande')}}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                <span id="notificationIndicator" style="color: red;">&#x1F514;</span> <!-- Utiliser l'icône des paramètres ici -->
                                <p>
                                   Notifications
                                </p>
                            </a>
