...
.sidebar-custom-color {
    background-color: rgb(40, 32, 193); /* Vous pouvez ajuster cette couleur selon vos préférences */
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a class="nav-link" href="{{route('DAF/acceuil')}}">Acceuil</a>
                </li>
                ...
                <ul class="navbar-nav ml-auto"> <!-- Utilisez ml-auto pour aligner à droite -->
                    <li class="nav-item">
                        <div class="user-panel mt-2 pb-2 mb-2 d-flex">
                            <div class="preloader flex-column justify-content-center align-items-center">
                                <img class="animation__shake" src="public/dist/img/logo.png" alt="logo" height="80" width="80">

                            </div>
                            <div class="info">
                                @if(Auth::check())
                                <div class="d-block" style="font-size: 20px; color:#4e49ea">{{ Auth::user()->roles->type_utilisateur }} -{{ Auth::user()->structures->nom }}</div>
                                @endif
                            </div>
                        </div>
                    </li>
        ...
        <aside  class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                 {{--<img src="public/dist/img/logo.png" alt="logo" class="brand-image img-circle elevation-3" style="opacity: .8">--}}
                <span class="brand-text font-weight-light" style="font-size: 15px;">GESTION DE STOCK</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{route('DAF/acceuil')}}" class="nav-link active">
                        ...
                        <li class="nav-item">
                            <a href="{{route('DAF/demande')}}" class="nav-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('DAF/statistiques')}}" class="nav-link">
