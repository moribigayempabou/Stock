...
<div>
            ...
            @endif
            <form id="form_materiel" action="{{ route('CSAF/affectations.csafupdate', ['affectation' => $affectation->id]) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <select id="materiels_id" class="form-control" name="materiels_id">
                        ...
                        <div style="display: inline-block; margin-right: 30px;">
                            ...
                            <a href="{{route('CSAF/affectes')}}" class="btn btn-danger" >Fermer</a>
                        </div>
                    </div>
                </form>
            </div>
