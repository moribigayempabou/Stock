    ...
    <tr>
        ...
        <td>
            @if ($materiel->quantite_reste > 0)
                <a href="{{ route('CSAF/Affectations.edite', ['materiel' => $materiel->id]) }}" class="btn btn-info me-2 affecter-btn" data-materiel-id="{{ $materiel->id }}">
                    Affecter
                </a>
            @else
                <a href="#" class="btn btn-red me-2 disabled-btn" style="color: red" data-materiel-id="{{ $materiel->id }}">
                    Affecter
                </a>
            @endif
        </td>
