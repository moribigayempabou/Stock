    ...
    <table class="table table-bordered border-secondary">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    {{--<a href="{{ route('CSAF/affectations.edit', ['affectation' => $affectation->id]) }}" class="btn btn-info me-2">
                       Editer <i class="fas fa-pencil-alt"></i> <!-- Utiliser l'icône de modification de Font Awesome ici -->
                    </a>--}}
                    <a href="{{ route('CSAF/retouner', ['id' => $affectation->id]) }}" class="btn btn-warning">
