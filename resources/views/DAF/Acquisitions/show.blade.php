        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                <div class="input-group input-group-sm" style="width: 200px;">
                   <a href="{{ route('DAF/acquisitions') }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Retour</a>
    ...
    <div class="modal fade" id="mediumModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="form_materiel" action="{{ route('DAF/materiels.store') }}" method="POST">
                    @csrf
        ...
        <div>
            ...
            <p>N° : {{ $acquisition->id}}</p>
            <p>Type: {{ $acquisition->type_acquisitions->libelle }}</p>
            <p>Source : {{ $acquisition->source }}</p>
            <p>Description : {{ $acquisition->description }}</p>
            <p>Date : {{ $acquisition->created_at }}</p><br>
 </div>
 <div>
    <div class="card">
        <div class="card-header">
        ...
        @foreach ($acquisition->materiels as $materiel)
            <tr>
                ...
                <td>
                    ...
                    <div class="d-flex">
                        <a href="{{ route('DAF/materiels.edit', ['materiel' => $materiel->id]) }}" class="btn btn-info me-2">
                            <i class="fas fa-pencil-alt"></i></a>
                        <a href="{{ route('DAF/materiels.show', ['id' => $materiel->id]) }}" class="btn btn-primary me-2">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form id="form-{{$materiel->id}}" method="POST" action="{{ route('DAF/materiels.delete', $materiel->id) }}">
                            @csrf
                            @method('DELETE')
