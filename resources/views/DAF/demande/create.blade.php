        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('DAF/demande.dafstore') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="destinataire_id" id="destinataire_id" class="form-control">
                                    ...
                                    @foreach($recepteurs as $recepteur)
                                        @if($recepteur->roles->type_utilisateur === 'CSAF')
                                            <option value="{{ $recepteur->id }}">{{ $recepteur->roles->type_utilisateur }}-{{ $recepteur->structures->nom }}</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
