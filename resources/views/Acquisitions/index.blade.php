    ...
    <div>
        ...
        <div class="pull-right">
            <a class="btn btn-success text-light" data-toggle="modal" id="mediumButton" data-target="#mediumModal"
                data-attr="{{ route('acquisitions.create') }}" >Ajouter <i class="fas fa-plus-circle"></i>
            </a>
        </div><br><br>
        ...
        <table id="materiels_table" class="table table-bordered">
            ...
            <tbody class="table-group-divider">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('acquisitions.show', ['id' => $acquisition->id]) }}" class="btn btn-primary me-2">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form method="POST" action="{{ route('acquisitions.store') }}">
                    @csrf
